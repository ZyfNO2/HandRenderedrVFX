...
namespace VolumetricLights {
    ...
    public class VolumetricLightProfile : ScriptableObject {
        ...
        [Range(0.1f, 1)] public float raymarchMinStep = 0.1f;
        ...
        [Tooltip("Fully enable/disable particle system associated to this volumetric light based on distance to main camera in order to optimize performance")]
