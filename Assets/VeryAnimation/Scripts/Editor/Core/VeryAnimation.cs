...
#if UNITY_2018_3_OR_NEWER
            prefabMode = UnityEditor.SceneManagement.PrefabStageUtility.GetCurrentPrefabStage() != null;
#else
            prefabMode = false;
#endif
...
#endif
#if UNITY_2018_3_OR_NEWER
                if (edit && prefabMode != (UnityEditor.SceneManagement.PrefabStageUtility.GetCurrentPrefabStage() != null))
                    return -140;
                if (vaw.uPrefabStage.GetAutoSave(UnityEditor.SceneManagement.PrefabStageUtility.GetCurrentPrefabStage()))
                    return -141;
                if (UnityEditor.SceneManagement.PrefabStageUtility.GetCurrentPrefabStage() != null &&
                    !EditorCommon.IsAncestorObject(uAw.GetActiveRootGameObject(), UnityEditor.SceneManagement.PrefabStageUtility.GetCurrentPrefabStage().prefabContentsRoot))
                    return -142;
#endif
