...
[ExecuteInEditMode]
public class MyOtherLightSecond : MonoBehaviour
{
    ...
    private void Update()
    {
        Shader.SetGlobalVector("_LightDirSecond", -transform.forward);
        Shader.SetGlobalVector("_LightColorSecond", LightColor);
